...
using TicketStore.Gateway.BackgroundServices;
using TicketStore.Gateway.Services;

namespace TicketStore.Gateway
{
    public class Startup
    {
        ...
        {
            services.AddHttpClient<IEventCatalogService, EventCatalogService>(c => c.BaseAddress = new Uri("http://localhost:33977/"));
